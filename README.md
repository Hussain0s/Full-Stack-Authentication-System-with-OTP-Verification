...
Project Structure
/components: Contains all the React components (e.g., Login, Register, ForgotPassword, etc.).

/styles: Contains CSS files for styling each component.
...
Screenshots
(You can add screenshots of the login, register, forgot password, and other pages here.)
